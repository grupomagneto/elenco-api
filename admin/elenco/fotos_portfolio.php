...
?>
  <tr>
    ...
    <td><a href="#a" onclick="javascript: confirmaExclusao('/magnetoelenco/sys/del/del_elenco_foto.php?id_tipo_foto=2&id_elenco=<?= $id_elenco; ?>&id_foto=<?= $id_foto; ?>&arquivo=<?= $arquivo; ?>');">excluir</a></td>
  </tr>
<?php
		}
?>
