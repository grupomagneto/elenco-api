...
?>
  <tr>
    <td><img border="0" src="/magnetoelenco/thumb/<?= $nome_thumb ?>" /></td>
    <td><a href="#a" onclick="javascript: confirmaExclusao('/magnetoelenco/sys/del/del_elenco_foto2.php?id_tipo_foto=1&id_elenco=<?= $id_elenco; ?>&id_foto=<?= $id_foto; ?>&arquivo=<?= $arquivo; ?>');">excluir</a></td>
  </tr>
<?php
		}
?>
