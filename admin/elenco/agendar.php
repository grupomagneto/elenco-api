<?php
	...
	if($id_elenco == "") header("Location: reagendar_confirmacao.php?flag=3");
	...
	$calendario->pagina_link = "/admin/elenco/agendar.php?id_elenco=$id_elenco&";
...
<title>Magneto Elenco - Agendamento</title>
...
<table width="100%" border="0" cellspacing="0">
  <tr bgcolor="#b3141a">
    <td width="25"><a href="?id_elenco=<?= $id_elenco; ?>&data=<?= formataData($anterior_dia); ?>"><img src="../img/seta_esq.gif" width="25" height="22" /></a></td>
    <td  align="center" class="font_br" style="text-transform:uppercase;"><?= $data_extenso ?></td>
    <td width="25" align="right"><a href="?id_elenco=<?= $id_elenco; ?>&data=<?= formataData($proximo_dia); ?>"><img src="../img/seta_dir.gif" width="25" height="22" /></a></td>
  </tr>
</table><br>
...
<div class="btr">
<form name="form_reagendar" id="form_reagendar" method="post" action="/sys/insert/ins_agenda_horario.php">
	...
	<input type="image" src="../img/bt_confirmar.gif" />
</form>
</div>
</body>
</html>
