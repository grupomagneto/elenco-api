...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="48%">
<?php include("../includes/form_busca_elenco.php"); ?>
...
<table width="98%" align="center" border="0" cellpadding="5" cellspacing="0">
  <tr bgcolor="#c3161c">
    <td class="font_br">
		<table>
			<tr>
				<td><a href="<? echo $_SERVER['PHP_SELF']."?ordenacao=nome&sentido=$link_sentido_nome&pagina=1"; ?>"><img src="/magnetoelenco/admin/img/<?= $img_seta_nome; ?>" border="0" /></a></td>
    ...
    <td class="font_br">
		<table>
			<tr>
				<td><a href="<? echo $_SERVER['PHP_SELF']."?ordenacao=nome_artistico&sentido=$link_sentido_artistico&pagina=1"; ?>"><img src="/magnetoelenco/admin/img/<?= $img_seta_artistico; ?>" border="0" /></a></td>
