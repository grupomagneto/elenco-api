...
<img src="../img/tit_videofolio.gif" width="191" height="68" class="tit" />


<form enctype="multipart/form-data" method="post" action="/sys/upload/upload_elenco_video.php">
<table width="600" border="0" cellpadding="4">
  ...
  <tr>
    <td>&nbsp;</td>
    <td>
		<input type="hidden" name="cd_tipo_video" value="2" />
...
?>
  <tr>
    ...
    <td><a href="#a" onclick="javascript: confirmaExclusao('/sys/del/del_elenco_video.php?id_tipo_video=2&id_elenco=<?= $id_elenco; ?>&id_video=<?= $id_video; ?>&arquivo=<?= $arquivo; ?>');">excluir</a></td>
  </tr>
<?php
		}
?>
