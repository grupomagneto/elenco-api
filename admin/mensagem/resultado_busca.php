...
<?php
	...
	switch($pesquisa_condicao){
		...
		case 5:
			...
			break;
		case 6:
			$condicao_busca = "where bairro = nome_busca";
			break;
		default:
			$condicao_busca = "";
			break;
	...
	if($pesquisa_nome != ""){
		if($condicao_busca == ""){
			$condicao_busca = "where bairro like '%$pesquisa_nome%'";
		}
		else{
			$condicao_busca .= " and (bairro like '%$pesquisa_nome%')";
		}
	}

	include("../mensagem/form_busca_elenco.php");
?>
...
<table width="98%" align="center" border="0" cellpadding="5" cellspacing="0">
  <tr bgcolor="#c3161c">
    <td class="font_br">
		<table>
			<tr>
				<td><a href="<? echo $_SERVER['PHP_SELF']."?ordenacao=nome&sentido=$link_sentido_nome&pagina=1&condicao=$pesquisa_condicao&nome_busca=$nome_busca"; ?>"><img src="/admin/img/<?= $img_seta_nome; ?>" border="0" /></a></td>
    ...
    <td class="font_br">
		<table>
			<tr>
				<td><a href="<? echo $_SERVER['PHP_SELF']."?ordenacao=nome_artistico&sentido=$link_sentido_artistico&pagina=1&condicao=$pesquisa_condicao&nome_busca=$nome_busca"; ?>"><img src="/admin/img/<?= $img_seta_artistico; ?>" border="0" /></a></td>
