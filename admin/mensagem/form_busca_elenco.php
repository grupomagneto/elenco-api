<!-- busca -->
<form name="busca_elenco" method="post" action="/magnetoelenco/admin/mensagem/resultado_busca.php">
<table width="490" border="0" cellpadding="0">
	<tr>
	<td width="33%">Buscar por:<br />
		<select name="condicao" id="condicao">
			<option value="0">---</option>
			<option value="6" <?php if($pesquisa_condicao == 5) echo "selected"; ?>>Bairro</option>
