<?php
	...
	// Recebe os ids dos elencos cadastrados no casting
	$array_elenco = getRegistrosTabelaAssociativa("ta_casting_elenco", "cd_elenco", "cd_casting", $id_casting);

	// Inicia a criacao do PDF
	$pdf=new FPDF();
	$pdf->SetTopMargin(4);

	// Gera uma pagina para cada elenco do casting
	foreach($array_elenco as $id_elenco){
	...
	// Printa o pdf
	$pdf->Output("Magneto_Elenco_Casting_$id_casting.pdf", "I");
?>
