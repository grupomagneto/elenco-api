<?php
	...
	if(!isset($id_elenco)){
		header("Location: /v2/nao_encontrado.php");
	}	
	...
	while($row = mysql_fetch_array($rs_fotos)){
		...
		$fotos[$i] = $_SERVER['DOCUMENT_ROOT']."/pdf/".$nome_thumb;
		$i++;
	}
	...
	// Cabecalho Logo
	$pdf->Image($_SERVER['DOCUMENT_ROOT'].'/v2/img/logo_elenco_300.jpg', 20, NULL, 80, NULL, 'JPG');
