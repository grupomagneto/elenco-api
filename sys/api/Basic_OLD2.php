...
function enviaArquivo($arquivo, $nome_arquivo, $cd_elenco, $cd_tipo_foto, $diretorio, $data, $gera_thumb = false, $gera_pdf = false){
	...
	if(uploadArquivo($arquivo, $nome_formatado, $diretorio)){
		...
		if($gera_thumb){
			...
			file_get_contents("http://www.vinigoulart.com/magnetoelenco/v2/thumb.php?src=".$nome_formatado."&dest=".$nome_thumb."&x=72&y=72");
		}
		...
		if($gera_pdf){
			...
			file_get_contents("http://www.vinigoulart.com/magnetoelenco/v2/thumb_pdf.php?src=".$nome_formatado."&dest=".$nome_thumb214."&x=214&y=214");

			$nome_thumb103 = $array_arquivo[0]."_103x103.".$array_arquivo[1];
			file_get_contents("http://www.vinigoulart.com/magnetoelenco/v2/thumb_pdf.php?src=".$nome_formatado."&dest=".$nome_thumb103."&x=103&y=103");			
		}		
