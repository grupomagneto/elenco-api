...
if(isset($_POST['sub'])){
  ...
  if($usuario_magneto === 'anelise' && $password_magneto === 'Analucia2016'){
    $_SESSION['login'] = true; header('LOCATION:inicio.html'); die();
  }
  if($usuario_magneto !== 'anelise')$userError = 'Usuário Inválido';
  if($password_magneto !== 'Analucia2016')$passError = 'Senha Inválida';
}
echo "<!DOCTYPE html>
