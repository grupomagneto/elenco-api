...
date_default_timezone_set('America/Sao_Paulo');
	...
	$sql2 = "INSERT INTO tb_votes (game_ID, level, winner_candidate_ID, loser_candidate_ID, vote_date, vote_time, vote_delay) VALUES ('$game_ID','$write_level','$winner_candidate_ID','$loser_candidate_ID','$vote_date','$vote_time','$vote_delay')";
	mysqli_query($link2, $sql2);
	if ($page <= $total_pages) {
		header("Location: pagination.php?game_ID=$game_ID&page=$page&level=$view_level");
	}
	else {
		if ($view_level == 0){
			$page=1;
