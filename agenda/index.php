...
if(isset($_POST['sub'])){
  ...
  if($usuario_magneto === 'agenda' && $password_magneto === 'Juliana&Julia2016'){
    $_SESSION['login'] = true; header('LOCATION:inicio.html'); die();
  }
  if($usuario_magneto !== 'agenda')$userError = 'Usuário Inválido';
  if($password_magneto !== 'Juliana&Julia2016')$passError = 'Senha Inválida';
}
echo "<!DOCTYPE html>
