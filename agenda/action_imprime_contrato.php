...
if (!empty($_GET['id'])) {
    ...
    $sql = "SELECT * FROM novo_cadastro WHERE id_elenco = '$id'";
    $result = mysqli_query($link, $sql);
      while ($row = mysqli_fetch_array($result)) {
        ...
        $cpf_responsavel          = $row[8];
        $tipo_cadastro            = $row[5];
        $tipo_cadastro_efetivado  = $row[6];
        $cpf                      = $row[13];
        $bairro                   = $row[11];
...
<table width='500' cellspacing='0' cellpadding='0' class='t1'>
  <tbody>
    ...
    <tr>
      ...
      <td valign='top' class='td2'>
        <div style='height:12px; overflow:hidden'><p class='p6'>ANELISE CATUNDA DE CLODOALDO PINTO CPF: 022.808.181-59</p></div>
      </td>
    </tr>
  </tbody>
</table>
...
<p class='p11'><br></p>
<p class='p8'><b>Parágrafo segundo:</b> A remuneração do <b>CONTRATANTE</b> por cada trabalho de foto/vídeo realizado será de 30% (trinta por cento) pela prestação do serviço e 70% (setenta por cento) pela utilização de sua imagem.</p>
<p class='p10'><br></p>
...
<p class='p10'><br></p>
<p class='p8'><b>CLÁUSULA 4<sup>a</sup>: </b>O <b>CONTRATANTE </b>cede à <b>CONTRATADA</b> os direitos e o uso de sua imagem e expressões artísticas pelo tempo de duração do Contrato, no território nacional ou fora dele, em qualquer meio de comunicação, reconhecendo que a imagem e seus direitos de exploração também serão utilizados em meio virtual, principalmente no site da <b>CONTRATADA</b>, reconhecendo ainda ser da exclusiva propriedade da <b>CONTRATADA</b> o material obtido nas sessões de fotografia e vídeo do <b>CONTRATANTE</b>.</p>
<p class='p11'><br></p>
<p class='p8'><b>Parágrafo primeiro:</b> A <b>CONTRATADA</b> poderá comercializar o material fotográfico com terceiros, desde que o <b>CONTRATANTE </b>autorize; poderá também vender o material fotográfico para o próprio <b>CONTRATANTE, </b>conforme descrito na cláusula 6<sup>a</sup>.</p>
<p class='p11'><br></p>
...
<p class='p11'><br></p>
<p class='p8'><b>CLÁUSULA 5<sup>a</sup>:</b> O <b>CONTRATANTE</b> dispensa a citação de seu nome ou crédito autoral na divulgação das obras fotográficas cujos direitos são por ele aqui cedidos, não se responsabilizando a <b>CONTRATADA </b>pela captação ou uso indevido de imagem por terceiros com quem a <b>CONTRATADA</b> não negociou.</p>
<p class='p10'><br></p>
...
if ($tipo == 'Premium' || $tipo == 'Ensaio' || $tipo == 'Ator') {
...
echo"
<p class='p10'><br></p>
<p class='p8'><b>Parágrafo primeiro:</b> Em caso de opção pelo 'CADASTRO GRATUITO', se ocorrer descumprimento da cláusula de exclusividade pelo <b>CONTRATANTE</b>,<span class='Apple-converted-space'>  </span>ele ficará sujeito ao pagamento de multa no valor de R$ 1.000,00 (mil reais), acrescidos de correção monetária e juros moratórios de 1% ao mês desde a data da constatação do prejuízo pela <b>CONTRATADA</b> até o pagamento, como forma de reparação mínima.</p>
<p class='p10'><br></p>
<p class='p8'><b>Parágrafo segundo:</b> Caso o <b>CONTRATANTE</b> deseje trocar a modalidade da relação estabelecida na cláusula 6<sup>a</sup>, <span class='s2'>de 'CADASTRO GRATUITO' para 'CADASTRO PREMIUM'</span>, esta poderá ocorrer sem cobranças adicionais, se realizada antes da <i>1<sup>a</sup> sessão de fotos e vídeo de cadastro</i>.</p>
<p class='p10'><br></p>
<p class='p8'><b>Parágrafo terceiro:</b> Após a realização da <i>1<sup>a</sup> sessão de fotos e vídeo de cadastro</i>, as trocas de modalidade da relação estabelecida na cláusula 6<sup>a</sup>, <span class='s2'>de 'CADASTRO GRATUITO' para 'CADASTRO PREMIUM'</span>, só poderão ocorrer mediante o acréscimo de multa de R$ 100,00 sobre o valor vigente do 'CADASTRO PREMIUM'.</p>
<p class='p10'><br></p>
<p class='p8'><b>Parágrafo quarto:</b> Caso o <b>CONTRATANTE</b> deseje trocar a modalidade da relação estabelecida na cláusula 6<sup>a</sup>, <span class='s2'>de 'CADASTRO PREMIUM' para 'CADASTRO GRATUITO'</span>, esta poderá ocorrer apenas antes da realização da <i>1<sup>a</sup> sessão de fotos e vídeo</i> e exclusivamente para horários agendados durante os dias de semana. Para sessões agendadas aos sábados (dia reservado exclusivamente para recepção de agenciados que optarem pelo 'CADASTRO PREMIUM'), a <b>CONTRATADA</b> se reserva o direito de recusar o atendimento de optantes pelo 'CADASTRO GRATUITO'.</p>
<p class='p10'><br></p>
<p class='p8'><b>CLÁUSULA 7<sup>a</sup>: </b>Na hipótese de opção pelo 'CADASTRO PREMIUM', previsto na Cláusula 6<sup>a</sup>, será retido pela <b>CONTRATADA </b>o percentual de 20% (vinte por cento) do montante líquido sobre cada cachê resultante de qualquer trabalho do <b>CONTRATANTE</b>, ficando, portanto, o <b>CONTRATANTE</b> com o valor de 80% (oitenta por cento) do montante líquido de cada cachê. Por montante líquido entende-se o valor do cachê após pagos os impostos e feitas as deduções legais na nota fiscal de serviço.</p>
<p class='p10'><br></p>
...
<p class='p10'><br></p>
<p class='p8'><b>CLÁUSULA 10<sup>a</sup>:</b> O Contrato tem prazo de duração de 24 (vinte e quatro) meses contados da assinatura ou aceitação eletrônica do instrumento e substitui as versões anteriores firmadas entre as partes.<span class='Apple-converted-space'> </span></p>
<p class='p9'><br></p>
